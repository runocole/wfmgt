...
class UserSerializer(serializers.ModelSerializer):
    ...
    # Remove the profile field since it doesn't exist
...
class WorkLogSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        # 10pm check removed — locking is handled by the 8am next-day lock
        # Staff can backdate entries at any time until 8am the following day
