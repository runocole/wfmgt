...
from . import views
from .views import bulk_delete_worklogs
...
urlpatterns = [
    ...
    path('admin/worklog/bulk-delete/', bulk_delete_worklogs, name='bulk_delete_worklogs'),
    # Leave Management
    ...
    path('admin/worklog/absences/', views.AdminAbsencesView.as_view(), name='admin-absences'),
    path('worklog/my-absences/', views.MyAbsenceDatesView.as_view(), name='my-absences'),
    # Queries
    path('admin/worklog/queries/', views.AdminQueryListView.as_view(), name='admin-query-list'),
    path('admin/worklog/queries/create/', views.AdminCreateQueryView.as_view(), name='admin-query-create'),
    path('admin/worklog/deleted-logs/', views.DeletedLogsView.as_view(), name='deleted-logs'),
    path('admin/kpis/', views.DepartmentKPIView.as_view(), name='department-kpis'),
    path('admin/performance/generate/', views.GeneratePerformanceReportView.as_view(), name='generate-report'),
    path('admin/performance/reports/', views.GetPerformanceReportsView.as_view(), name='performance-reports'),
    path('admin/worklog/queries/<int:query_id>/resolve/', views.AdminResolveQueryView.as_view(), name='admin-query-resolve'), 
    path('worklog/queries/', views.StaffQueryListView.as_view(), name='staff-query-list'),
    path('worklog/queries/<int:query_id>/respond/', views.StaffRespondQueryView.as_view(), name='staff-query-respond'),
    path('worklog/public-holidays/', views.PublicHolidayListView.as_view(), name='public-holidays'),
]
