...
SECRET_KEY = 'django-insecure-k9f8ohm&)m7hrh2&ebu67g(p==_#+4(+gnx$h-jl!d2b!)8&r%'
...
# CORS settings
# Add these with your other CORS settings
...
# Email settings for production (using Gmail as example)
